  ...
  <DashboardLayout>
    <div :class="['consultoria-container', { dark: isDarkMode }]">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-6 mt-8">
        ...
        <div @click="goToRoute('consultoria-listado')"
        ...
        <div @click="goToRoute('dependencias')"
      ...
      <div class="mt-12" v-if="mostrarBotones">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <button @click="goToRoute('faq')" :class="['action-button', { 'dark-action-button': isDarkMode, 'bg-purple-500': !isDarkMode }]">
