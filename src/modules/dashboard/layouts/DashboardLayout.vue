    ...
    >
      <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
          ...
          <li v-for="(padre, index) in menuRutas" :key="index">
            <a
            ...
            <ul v-if="padre.rutasHijas.length" class="ml-2 space-y-1">
              <li v-for="(hija, subIndex) in padre.rutasHijas" :key="subIndex">
                <a
                ...
                >
                  <span class="ms-4">{{ hija.ruta_nombre }}</span>
                </a>
              </li>
            </ul>
          </li>
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">
              <div class="flex items-center ms-3">
                <div class="flex items-center ms-3">
                  <span class="text-gray-700 text-sm font-semibold dark:text-gray-300 ml-2 pr-4"
                  ...
                  <ul class="py-1" role="none">
                    ...
                    <li>
                      <span
                        ...
                        role="menuitem"
                      >
                        <i class="fas fa-sign-out-alt mr-2"></i> Cerrar Sesión</span
                      >
                    </li>
                  </ul>
                </div>
...
// 🔹 Construye la estructura de menú agrupando rutas padre e hijas
const menuRutas = computed(() => {
  ...
  return Array.from(rutasMap.values()).filter((ruta) => ruta.ruta_padre === 0);
});
